...
function DrawBoxT($title, $width = "100%", $args = null)
{
    ...
    .'; text-align: left;" cellspacing="0" cellpadding="0"><tr>
    <td style="width: 100%; padding: 4px; font-size: 14px; border-bottom: 1px solid #FBECA7; font-weight: bold;">'
    .$title .'</td></tr><tr>
...
{
    echo '<div style="font-size: 18px;"><span style="color: #609FD7;">&bull;</span> '
    .$in_title .'</div><div style="padding-top: 6px; padding-left: 2px;">';
}
